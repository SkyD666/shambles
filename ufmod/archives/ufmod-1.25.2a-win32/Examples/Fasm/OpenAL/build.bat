...
"%UF_FASM%\fasm" mini_al.asm
%UF_LNKPATH% /SUBSYSTEM:WINDOWS /ENTRY:start /RELEASE /OPT:nowin98 /LIBPATH:"%UF_LIBS%" /STUB:stub.bin /MERGE:.rdata=.text mini_al.obj oalufmod.obj kernel32.lib user32.lib openal32.lib
del mini_al.obj
goto TheEnd
