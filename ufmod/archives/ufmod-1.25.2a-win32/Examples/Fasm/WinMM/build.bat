...
"%UF_FASM%\fasm" minimal.asm
%UF_LNKPATH% /SUBSYSTEM:WINDOWS /ENTRY:start /RELEASE /OPT:nowin98 /LIBPATH:"%UF_LIBS%" /STUB:stub.bin /MERGE:.rdata=.text minimal.obj ufmod.obj kernel32.lib user32.lib winmm.lib
del minimal.obj
goto TheEnd
