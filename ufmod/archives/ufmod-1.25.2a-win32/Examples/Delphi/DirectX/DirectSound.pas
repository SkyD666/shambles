{ *** DirectX DirectSound for Delphi *** }
...
function DirectSoundCaptureCreate(lpcGUID:REFGUID;lplpDSC:PDirectSoundCapture;pUnkOuter:Pointer):LongInt; stdcall; external 'dsound.dll';
function DirectSoundCaptureCreate8(lpcGUID:REFGUID;lplpDSC:PDirectSoundCapture;pUnkOuter:Pointer):LongInt; stdcall; external 'dsound.dll';
function DirectSoundCaptureEnumerateA(lpDSEnumCallback,lpContext:Pointer):LongInt; stdcall; external 'dsound.dll';
function DirectSoundCaptureEnumerateW(lpDSEnumCallback,lpContext:Pointer):LongInt; stdcall; external 'dsound.dll';
...
function DirectSoundCreate8(lpcGuid:REFGUID;ppDS8:PDirectSound8;pUnkOuter:Pointer):LongInt; stdcall; external 'dsound.dll';
function DirectSoundEnumerateA(lpDSEnumCallback,lpContext:Pointer):LongInt; stdcall; external 'dsound.dll';
function DirectSoundEnumerateW(lpDSEnumCallback,lpContext:Pointer):LongInt; stdcall; external 'dsound.dll';
function DirectSoundFullDuplexCreate8(pcGuidCaptureDevice,pcGuidRenderDevice:REFGUID;pcDSCBufferDesc:PDSCBUFFERDESC;pcDSBufferDesc:PDSBUFFERDESC;hWnd,dwLevel:LongWord;ppDSFD:PDirectSoundFullDuplex;ppDSCBuffer8:PDirectSoundCaptureBuffer8;ppDSBuffer8:PDirectSoundBuffer8;pUnkOuter:Pointer):LongInt; stdcall; external 'dsound.dll' name 'DirectSoundFullDuplexCreate';
function DSOUND_DllCanUnloadNow:LongInt; stdcall; external 'dsound.dll' name 'DllCanUnloadNow';
function DSOUND_DllGetClassObject(rclsid,riid:REFGUID;ppv:Pointer):LongInt; stdcall; external 'dsound.dll' name 'DllGetClassObject';
function GetDeviceID(pGuidSrc,pGuidDest:REFGUID):LongInt; stdcall; external 'dsound.dll';
