...
begin
	...
	begin
		...
		begin
			...
			{ Start playback. }
			if uFMOD_OALPlaySong(@xm,Length(xm),XM_MEMORY,OAL_Source) <> 0 then
			begin
				error_flag := 0;
	...
	if error_flag = 1 then MessageBox(0,'Failed to initialize OpenAL',nil,$10);
