{ *** OpenAL v1.0 and v1.1 for Delphi *** }
...
procedure alGenBuffers(n:ALsizei;buffers:PALuint); cdecl; external 'openal32.dll';
procedure alDeleteBuffers(n:ALsizei;buffers:PALuint); cdecl; external 'openal32.dll';
function alIsBuffer(buffer:ALuint):ALboolean; cdecl; external 'openal32.dll';
procedure alBufferData(buffer:ALuint;format:ALenum;data:Pointer;size,freq:ALsizei); cdecl; external 'openal32.dll';
procedure alBufferf(buffer:ALuint;param:ALenum;value:ALfloat); cdecl; external 'openal32.dll';
procedure alBuffer3f(buffer:ALuint;param:ALenum;v1,v2,v3:ALfloat); cdecl; external 'openal32.dll';
procedure alBufferfv(buffer:ALuint;param:ALenum;values:PALfloat); cdecl; external 'openal32.dll';
procedure alBufferi(buffer:ALuint;param:ALenum;value:ALint); cdecl; external 'openal32.dll';
procedure alBuffer3i(buffer:ALuint;param:ALenum;v1,v2,v3:ALint); cdecl; external 'openal32.dll';
procedure alBufferiv(buffer:ALuint;param:ALenum;values:PALint); cdecl; external 'openal32.dll';
procedure alGetBufferf(buffer:ALuint;pname:ALenum;value:PALfloat); cdecl; external 'openal32.dll';
procedure alGetBuffer3f(buffer:ALuint;pname:ALenum;v1,v2,v3:PALfloat); cdecl; external 'openal32.dll';
procedure alGetBufferfv(buffer:ALuint;pname:ALenum;values:PALfloat); cdecl; external 'openal32.dll';
procedure alGetBufferi(buffer:ALuint;pname:ALenum;value:PALint); cdecl; external 'openal32.dll';
procedure alGetBuffer3i(buffer:ALuint;pname:ALenum;v1,v2,v3:PALint); cdecl; external 'openal32.dll';
procedure alGetBufferiv(buffer:ALuint;pname:ALenum;values:PALint); cdecl; external 'openal32.dll';
procedure alGenSources(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll';
procedure alDeleteSources(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll';
function alIsSource(source:ALuint):ALboolean; cdecl; external 'openal32.dll';
procedure alSourcef(source:ALuint;param:ALenum;value:ALfloat); cdecl; external 'openal32.dll';
procedure alSource3f(source:ALuint;param:ALenum;v1,v2,v3:ALfloat); cdecl; external 'openal32.dll';
procedure alSourcefv(source:ALuint;param:ALenum;values:PALfloat); cdecl; external 'openal32.dll';
procedure alSourcei(source:ALuint;param:ALenum;value:ALint); cdecl; external 'openal32.dll';
procedure alSource3i(source:ALuint;param:ALenum;v1,v2,v3:ALint); cdecl; external 'openal32.dll';
procedure alSourceiv(source:ALuint;param:ALenum;values:PALint); cdecl; external 'openal32.dll';
procedure alGetSourcef(source:ALuint;pname:ALenum;value:PALfloat); cdecl; external 'openal32.dll';
procedure alGetSource3f(source:ALuint;pname:ALenum;v1,v2,v3:PALfloat); cdecl; external 'openal32.dll';
procedure alGetSourcefv(source:ALuint;pname:ALenum;values:PALfloat); cdecl; external 'openal32.dll';
procedure alGetSourcei(source:ALuint;pname:ALenum;value:PALint); cdecl; external 'openal32.dll';
procedure alGetSource3i(source:ALuint;pname:ALenum;v1,v2,v3:PALint); cdecl; external 'openal32.dll';
procedure alGetSourceiv(source:ALuint;pname:ALenum;values:PALint); cdecl; external 'openal32.dll';
procedure alSourcePlay(source:ALuint); cdecl; external 'openal32.dll';
procedure alSourcePlayv(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll';
procedure alSourcePause(source:ALuint); cdecl; external 'openal32.dll';
procedure alSourcePausev(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll';
procedure alSourceStop(source:ALuint); cdecl; external 'openal32.dll';
procedure alSourceStopv(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll';
procedure alSourceRewind(source:ALuint); cdecl; external 'openal32.dll';
procedure alSourceRewindv(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll';
procedure alSourceQueueBuffers(source:ALuint;n:ALsizei;buffers:PALuint); cdecl; external 'openal32.dll';
procedure alSourceUnqueueBuffers(source:ALuint;n:ALsizei;buffers:PALuint); cdecl; external 'openal32.dll';
procedure alListenerf(param:ALenum;value:ALfloat); cdecl; external 'openal32.dll';
procedure alListener3f(param:ALenum;v1,v2,v3:ALfloat); cdecl; external 'openal32.dll';
procedure alListenerfv(param:ALenum;values:PALfloat); cdecl; external 'openal32.dll';
procedure alListeneri(param:ALenum;value:ALint); cdecl; external 'openal32.dll';
procedure alListener3i(param:ALenum;v1,v2,v3:ALint); cdecl; external 'openal32.dll';
procedure alListeneriv(param:ALenum;values:PALint); cdecl; external 'openal32.dll';
procedure alGetListenerf(pname:ALenum;value:PALfloat); cdecl; external 'openal32.dll';
procedure alGetListener3f(pname:ALenum;v1,v2,v3:PALfloat); cdecl; external 'openal32.dll';
procedure alGetListenerfv(pname:ALenum;values:PALfloat); cdecl; external 'openal32.dll';
procedure alGetListeneri(pname:ALenum;value:PALint); cdecl; external 'openal32.dll';
procedure alGetListener3i(pname:ALenum;v1,v2,v3:PALint); cdecl; external 'openal32.dll';
procedure alGetListeneriv(pname:ALenum;values:PALint); cdecl; external 'openal32.dll';
procedure alEnable(capability:ALenum); cdecl; external 'openal32.dll';
procedure alDisable(capability:ALenum); cdecl; external 'openal32.dll';
function alIsEnabled(capability:ALenum):ALboolean; cdecl; external 'openal32.dll';
function alGetBoolean(pname:ALenum):ALboolean; cdecl; external 'openal32.dll';
function alGetDouble(pname:ALenum):ALdouble; cdecl; external 'openal32.dll';
function alGetFloat(pname:ALenum):ALfloat; cdecl; external 'openal32.dll';
function alGetInteger(pname:ALenum):ALint; cdecl; external 'openal32.dll';
procedure alGetBooleanv(pname:ALenum;data:PALboolean); cdecl; external 'openal32.dll';
procedure alGetDoublev(pname:ALenum;data:PALdouble); cdecl; external 'openal32.dll';
procedure alGetFloatv(pname:ALenum;data:PALfloat); cdecl; external 'openal32.dll';
procedure alGetIntegerv(pname:ALenum;data:PALint); cdecl; external 'openal32.dll';
function alGetString(pname:ALenum):PChar; cdecl; external 'openal32.dll';
procedure alDistanceModel(value:ALenum); cdecl; external 'openal32.dll';
procedure alDopplerFactor(value:ALfloat); cdecl; external 'openal32.dll';
procedure alDopplerVelocity(value:ALfloat); cdecl; external 'openal32.dll'; { Deprecated in v1.1: use alSpeedOfSound instead! }
procedure alSpeedOfSound(value:ALfloat); cdecl; external 'openal32.dll';
function alGetError:ALenum; cdecl; external 'openal32.dll';
function alIsExtensionPresent(extname:PChar):ALboolean; cdecl; external 'openal32.dll';
function alGetProcAddress(fname:PChar):Pointer; cdecl; external 'openal32.dll';
function alGetEnumValue(ename:PChar):ALenum; cdecl; external 'openal32.dll';
function alcCreateContext(device:PALCdevice;attrlist:PALCint):PALCcontext; cdecl; external 'openal32.dll';
function alcMakeContextCurrent(context:PALCcontext):ALCboolean; cdecl; external 'openal32.dll';
procedure alcProcessContext(context:PALCcontext); cdecl; external 'openal32.dll';
procedure alcSuspendContext(context:PALCcontext); cdecl; external 'openal32.dll';
procedure alcDestroyContext(context:PALCcontext); cdecl; external 'openal32.dll';
function alcGetCurrentContext:PALCcontext; cdecl; external 'openal32.dll';
function alcGetContextsDevice(context:PALCcontext):PALCdevice; cdecl; external 'openal32.dll';
function alcGetError(device:ALCdevice):ALCenum; cdecl; external 'openal32.dll';
function alcOpenDevice(devicename:PChar):PALCdevice; cdecl; external 'openal32.dll';
function alcCloseDevice(device:PALCdevice):ALCboolean; cdecl; external 'openal32.dll';
function alcIsExtensionPresent(device:PALCdevice;extname:PChar):ALCboolean; cdecl; external 'openal32.dll';
function alcGetProcAddress(device:PALCdevice;fname:PChar):Pointer; cdecl; external 'openal32.dll';
function alcGetEnumValue(device:PALCdevice;ename:PChar):ALCenum; cdecl; external 'openal32.dll';
function alcGetString(device:PALCdevice;param:ALCenum):PChar; cdecl; external 'openal32.dll';
procedure alcGetIntegerv(device:PALCdevice;param:ALCenum;size:ALCsizei;data:PALCint); cdecl; external 'openal32.dll';
function alcCaptureOpenDevice(devicename:PChar;frequency:ALCuint;format:ALCenum;buffersize:ALCsizei):PALCdevice; cdecl; external 'openal32.dll';
function alcCaptureCloseDevice(device:PALCdevice):ALCboolean; cdecl; external 'openal32.dll';
procedure alcCaptureStart(device:PALCdevice); cdecl; external 'openal32.dll';
procedure alcCaptureStop(device:PALCdevice); cdecl; external 'openal32.dll';
procedure alcCaptureSamples(device:PALCdevice;buffer:Pointer;samples:ALCsizei); cdecl; external 'openal32.dll';
