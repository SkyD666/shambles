{ *** uFMOD (DirectX) unit for FreePascal *** }
...
function uFMOD_DSPlaySong(lpXM:Pointer;param,fdwSong:LongWord;lpDSBuffer:IDirectSoundBuffer):LongInt; stdcall; external name '_uFMOD_DSPlaySong_16';
...
var i:LongInt;
begin
	i:=uFMOD_DSPlaySong(nil,0,0,nil)
end;
