{ *** uFMOD (OpenAL) unit for FreePascal *** }
...
function uFMOD_OALPlaySong(lpXM:Pointer;param,fdwSong,source:LongWord):LongWord; stdcall; external name '_uFMOD_OALPlaySong_16';
