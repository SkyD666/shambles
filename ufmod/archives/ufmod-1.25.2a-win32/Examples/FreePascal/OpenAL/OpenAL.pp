...
procedure alGenBuffers(n:ALsizei;buffers:PALuint); cdecl; external 'openal32.dll' name 'alGenBuffers';
procedure alDeleteBuffers(n:ALsizei;buffers:PALuint); cdecl; external 'openal32.dll' name 'alDeleteBuffers';
function alIsBuffer(buffer:ALuint):ALboolean; cdecl; external 'openal32.dll' name 'alIsBuffer';
procedure alBufferData(buffer:ALuint;format:ALenum;data:Pointer;size,freq:ALsizei); cdecl; external 'openal32.dll' name 'alBufferData';
procedure alBufferf(buffer:ALuint;param:ALenum;value:ALfloat); cdecl; external 'openal32.dll' name 'alBufferf';
procedure alBuffer3f(buffer:ALuint;param:ALenum;v1,v2,v3:ALfloat); cdecl; external 'openal32.dll' name 'alBuffer3f';
procedure alBufferfv(buffer:ALuint;param:ALenum;values:PALfloat); cdecl; external 'openal32.dll' name 'alBufferfv';
procedure alBufferi(buffer:ALuint;param:ALenum;value:ALint); cdecl; external 'openal32.dll' name 'alBufferi';
procedure alBuffer3i(buffer:ALuint;param:ALenum;v1,v2,v3:ALint); cdecl; external 'openal32.dll' name 'alBuffer3i';
procedure alBufferiv(buffer:ALuint;param:ALenum;values:PALint); cdecl; external 'openal32.dll' name 'alBufferiv';
procedure alGetBufferf(buffer:ALuint;pname:ALenum;value:PALfloat); cdecl; external 'openal32.dll' name 'alGetBufferf';
procedure alGetBuffer3f(buffer:ALuint;pname:ALenum;v1,v2,v3:PALfloat); cdecl; external 'openal32.dll' name 'alGetBuffer3f';
procedure alGetBufferfv(buffer:ALuint;pname:ALenum;values:PALfloat); cdecl; external 'openal32.dll' name 'alGetBufferfv';
procedure alGetBufferi(buffer:ALuint;pname:ALenum;value:PALint); cdecl; external 'openal32.dll' name 'alGetBufferi';
procedure alGetBuffer3i(buffer:ALuint;pname:ALenum;v1,v2,v3:PALint); cdecl; external 'openal32.dll' name 'alGetBuffer3i';
procedure alGetBufferiv(buffer:ALuint;pname:ALenum;values:PALint); cdecl; external 'openal32.dll' name 'alGetBufferiv';
procedure alGenSources(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll' name 'alGenSources';
procedure alDeleteSources(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll' name 'alDeleteSources';
function alIsSource(source:ALuint):ALboolean; cdecl; external 'openal32.dll' name 'alIsSource';
procedure alSourcef(source:ALuint;param:ALenum;value:ALfloat); cdecl; external 'openal32.dll' name 'alSourcef';
procedure alSource3f(source:ALuint;param:ALenum;v1,v2,v3:ALfloat); cdecl; external 'openal32.dll' name 'alSource3f';
procedure alSourcefv(source:ALuint;param:ALenum;values:PALfloat); cdecl; external 'openal32.dll' name 'alSourcefv';
procedure alSourcei(source:ALuint;param:ALenum;value:ALint); cdecl; external 'openal32.dll' name 'alSourcei';
procedure alSource3i(source:ALuint;param:ALenum;v1,v2,v3:ALint); cdecl; external 'openal32.dll' name 'alSource3i';
procedure alSourceiv(source:ALuint;param:ALenum;values:PALint); cdecl; external 'openal32.dll' name 'alSourceiv';
procedure alGetSourcef(source:ALuint;pname:ALenum;value:PALfloat); cdecl; external 'openal32.dll' name 'alGetSourcef';
procedure alGetSource3f(source:ALuint;pname:ALenum;v1,v2,v3:PALfloat); cdecl; external 'openal32.dll' name 'alGetSource3f';
procedure alGetSourcefv(source:ALuint;pname:ALenum;values:PALfloat); cdecl; external 'openal32.dll' name 'alGetSourcefv';
procedure alGetSourcei(source:ALuint;pname:ALenum;value:PALint); cdecl; external 'openal32.dll' name 'alGetSourcei';
procedure alGetSource3i(source:ALuint;pname:ALenum;v1,v2,v3:PALint); cdecl; external 'openal32.dll' name 'alGetSource3i';
procedure alGetSourceiv(source:ALuint;pname:ALenum;values:PALint); cdecl; external 'openal32.dll' name 'alGetSourceiv';
procedure alSourcePlay(source:ALuint); cdecl; external 'openal32.dll' name 'alSourcePlay';
procedure alSourcePlayv(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll' name 'alSourcePlayv';
procedure alSourcePause(source:ALuint); cdecl; external 'openal32.dll' name 'alSourcePause';
procedure alSourcePausev(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll' name 'alSourcePausev';
procedure alSourceStop(source:ALuint); cdecl; external 'openal32.dll' name 'alSourceStop';
procedure alSourceStopv(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll' name 'alSourceStopv';
procedure alSourceRewind(source:ALuint); cdecl; external 'openal32.dll' name 'alSourceRewind';
procedure alSourceRewindv(n:ALsizei;sources:PALuint); cdecl; external 'openal32.dll' name 'alSourceRewindv';
procedure alSourceQueueBuffers(source:ALuint;n:ALsizei;buffers:PALuint); cdecl; external 'openal32.dll' name 'alSourceQueueBuffers';
procedure alSourceUnqueueBuffers(source:ALuint;n:ALsizei;buffers:PALuint); cdecl; external 'openal32.dll' name 'alSourceUnqueueBuffers';
procedure alListenerf(param:ALenum;value:ALfloat); cdecl; external 'openal32.dll' name 'alListenerf';
procedure alListener3f(param:ALenum;v1,v2,v3:ALfloat); cdecl; external 'openal32.dll' name 'alListener3f';
procedure alListenerfv(param:ALenum;values:PALfloat); cdecl; external 'openal32.dll' name 'alListenerfv';
procedure alListeneri(param:ALenum;value:ALint); cdecl; external 'openal32.dll' name 'alListeneri';
procedure alListener3i(param:ALenum;v1,v2,v3:ALint); cdecl; external 'openal32.dll' name 'alListener3i';
procedure alListeneriv(param:ALenum;values:PALint); cdecl; external 'openal32.dll' name 'alListeneriv';
procedure alGetListenerf(pname:ALenum;value:PALfloat); cdecl; external 'openal32.dll' name 'alGetListenerf';
procedure alGetListener3f(pname:ALenum;v1,v2,v3:PALfloat); cdecl; external 'openal32.dll' name 'alGetListener3f';
procedure alGetListenerfv(pname:ALenum;values:PALfloat); cdecl; external 'openal32.dll' name 'alGetListenerfv';
procedure alGetListeneri(pname:ALenum;value:PALint); cdecl; external 'openal32.dll' name 'alGetListeneri';
procedure alGetListener3i(pname:ALenum;v1,v2,v3:PALint); cdecl; external 'openal32.dll' name 'alGetListener3i';
procedure alGetListeneriv(pname:ALenum;values:PALint); cdecl; external 'openal32.dll' name 'alGetListeneriv';
procedure alEnable(capability:ALenum); cdecl; external 'openal32.dll' name 'alEnable';
procedure alDisable(capability:ALenum); cdecl; external 'openal32.dll' name 'alDisable';
function alIsEnabled(capability:ALenum):ALboolean; cdecl; external 'openal32.dll' name 'alIsEnabled';
function alGetBoolean(pname:ALenum):ALboolean; cdecl; external 'openal32.dll' name 'alGetBoolean';
function alGetDouble(pname:ALenum):ALdouble; cdecl; external 'openal32.dll' name 'alGetDouble';
function alGetFloat(pname:ALenum):ALfloat; cdecl; external 'openal32.dll' name 'alGetFloat';
function alGetInteger(pname:ALenum):ALint; cdecl; external 'openal32.dll' name 'alGetInteger';
procedure alGetBooleanv(pname:ALenum;data:PALboolean); cdecl; external 'openal32.dll' name 'alGetBooleanv';
procedure alGetDoublev(pname:ALenum;data:PALdouble); cdecl; external 'openal32.dll' name 'alGetDoublev';
procedure alGetFloatv(pname:ALenum;data:PALfloat); cdecl; external 'openal32.dll' name 'alGetFloatv';
procedure alGetIntegerv(pname:ALenum;data:PALint); cdecl; external 'openal32.dll' name 'alGetIntegerv';
function alGetString(pname:ALenum):PChar; cdecl; external 'openal32.dll' name 'alGetString';
procedure alDistanceModel(value:ALenum); cdecl; external 'openal32.dll' name 'alDistanceModel';
procedure alDopplerFactor(value:ALfloat); cdecl; external 'openal32.dll' name 'alDopplerFactor';
procedure alDopplerVelocity(value:ALfloat); cdecl; external 'openal32.dll' name 'alDopplerVelocity'; { Deprecated in v1.1: use alSpeedOfSound instead! }
procedure alSpeedOfSound(value:ALfloat); cdecl; external 'openal32.dll' name 'alSpeedOfSound';
function alGetError:ALenum; cdecl; external 'openal32.dll' name 'alGetError';
function alIsExtensionPresent(extname:PChar):ALboolean; cdecl; external 'openal32.dll' name 'alIsExtensionPresent';
function alGetProcAddress(fname:PChar):Pointer; cdecl; external 'openal32.dll' name 'alGetProcAddress';
function alGetEnumValue(ename:PChar):ALenum; cdecl; external 'openal32.dll' name 'alGetEnumValue';
function alcCreateContext(device:PALCdevice;attrlist:PALCint):PALCcontext; cdecl; external 'openal32.dll' name 'alcCreateContext';
function alcMakeContextCurrent(context:PALCcontext):ALCboolean; cdecl; external 'openal32.dll' name 'alcMakeContextCurrent';
procedure alcProcessContext(context:PALCcontext); cdecl; external 'openal32.dll' name 'alcProcessContext';
procedure alcSuspendContext(context:PALCcontext); cdecl; external 'openal32.dll' name 'alcSuspendContext';
procedure alcDestroyContext(context:PALCcontext); cdecl; external 'openal32.dll' name 'alcDestroyContext';
function alcGetCurrentContext:PALCcontext; cdecl; external 'openal32.dll' name 'alcGetCurrentContext';
function alcGetContextsDevice(context:PALCcontext):PALCdevice; cdecl; external 'openal32.dll' name 'alcGetContextsDevice';
function alcGetError(device:ALCdevice):ALCenum; cdecl; external 'openal32.dll' name 'alcGetError';
function alcOpenDevice(devicename:PChar):PALCdevice; cdecl; external 'openal32.dll' name 'alcOpenDevice';
function alcCloseDevice(device:PALCdevice):ALCboolean; cdecl; external 'openal32.dll' name 'alcCloseDevice';
function alcIsExtensionPresent(device:PALCdevice;extname:PChar):ALCboolean; cdecl; external 'openal32.dll' name 'alcIsExtensionPresent';
function alcGetProcAddress(device:PALCdevice;fname:PChar):Pointer; cdecl; external 'openal32.dll' name 'alcGetProcAddress';
function alcGetEnumValue(device:PALCdevice;ename:PChar):ALCenum; cdecl; external 'openal32.dll' name 'alcGetEnumValue';
function alcGetString(device:PALCdevice;param:ALCenum):PChar; cdecl; external 'openal32.dll' name 'alcGetString';
procedure alcGetIntegerv(device:PALCdevice;param:ALCenum;size:ALCsizei;data:PALCint); cdecl; external 'openal32.dll' name 'alcGetIntegerv';
function alcCaptureOpenDevice(devicename:PChar;frequency:ALCuint;format:ALCenum;buffersize:ALCsizei):PALCdevice; cdecl; external 'openal32.dll' name 'alcCaptureOpenDevice';
function alcCaptureCloseDevice(device:PALCdevice):ALCboolean; cdecl; external 'openal32.dll' name 'alcCaptureCloseDevice';
procedure alcCaptureStart(device:PALCdevice); cdecl; external 'openal32.dll' name 'alcCaptureStart';
procedure alcCaptureStop(device:PALCdevice); cdecl; external 'openal32.dll' name 'alcCaptureStop';
procedure alcCaptureSamples(device:PALCdevice;buffer:Pointer;samples:ALCsizei); cdecl; external 'openal32.dll' name 'alcCaptureSamples';
