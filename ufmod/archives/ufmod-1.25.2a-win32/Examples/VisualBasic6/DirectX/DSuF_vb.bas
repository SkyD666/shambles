...
Function uFMOD_DSPlaySong(ByVal lpXM As Long, ByVal param As Long, ByVal fdwSong As Long, ByVal dsBuf As DirectSoundBuffer) As Long
        Err.Raise -1, "uFMOD_DSPlaySong", "uFMOD not found. Check the readme.txt for details."
End Function
