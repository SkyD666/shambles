...
"%NASM%\nasmw" -fwin32 minimal.asm
%LNKPATH% /SUBSYSTEM:WINDOWS /ENTRY:start /RELEASE /OPT:nowin98 /LIBPATH:"%LNK%\lib" /STUB:stub.bin /MERGE:.rdata=.text minimal.obj ufmod.obj kernel32.lib user32.lib winmm.lib
del minimal.obj
goto TheEnd
:Err1
