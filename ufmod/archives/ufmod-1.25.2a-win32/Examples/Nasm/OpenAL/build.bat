...
"%NASM%\nasmw" -fwin32 mini_al.asm
%LNKPATH% /SUBSYSTEM:WINDOWS /ENTRY:start /RELEASE /OPT:nowin98 /LIBPATH:"%LNK%\lib" /STUB:stub.bin /MERGE:.rdata=.text mini_al.obj oalufmod.obj kernel32.lib user32.lib openal32.lib
del mini_al.obj
goto TheEnd
:Err1
