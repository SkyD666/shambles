...
"%NASM%\nasmw" -fwin32 mini_ds.asm
%LNKPATH% /SUBSYSTEM:WINDOWS /ENTRY:start /RELEASE /OPT:nowin98 /LIBPATH:"%LNK%\lib" /STUB:stub.bin /MERGE:.rdata=.text mini_ds.obj dsufmod.obj kernel32.lib user32.lib dsound.lib
del mini_ds.obj
goto TheEnd
:Err1
